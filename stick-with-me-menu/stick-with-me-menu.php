...
function stickwithmemenu_init(){
	...
	add_settings_field('stickwithmemenu_enabled_setting','Stick With Me Menu','stickwithmemenu_displayform','general','default',array( 'label_for' => 'stickwithmemenu_enabled' ));
}
function stickwithmemenu_displayform($args){
	$value = get_option('stickwithmemenu_enabled', 'true' );
	?>
	<label for="<?php echo $args['label_for']; ?>"><input type="radio" id="<?php echo $args['label_for']; ?>" name="<?php echo $args['label_for']; ?>" value="true" <?php if($value != 'false'){echo 'checked';}?>/> Enabled</label>&nbsp;
	<label for="<?php echo $args['label_for']; ?>_off"><input type="radio" id="<?php echo $args['label_for']; ?>_off" name="<?php echo $args['label_for']; ?>" value="false" <?php if($value == 'false'){echo 'checked';}?>/> Disabled</label>
	<?php
}
?>
